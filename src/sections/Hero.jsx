  ...
  return (
    ...
    >
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
        ...
        <p className="text-slate-gray font-montserrat leading-8 text-lg mt-6 mb-14 sm:max-w-sm">
          Elevate Your Style and Performance with Nike's Iconic Shoe Collection{" "}
        </p>
